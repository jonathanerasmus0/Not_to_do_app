"""
Django settings for nottodo_project project.
...
SECRET_KEY = 'django-insecure-&g^i-cclqy2f$-wjga1wk0!(n59#572qaknp6%7u0)@arp_(#^'
...
CELERY_BEAT_SCHEDULE = {
    'send-nottodo-reminders': {
        'task': 'nottodo_app.tasks.send_nottodo_reminders',
